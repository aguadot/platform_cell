...
void loop() 
{
	...
	if (Serial.available()>0)
	{
		...
		if (primer_arranque == true) // cuando encendemos el programa nos vamos a la posicion del final de carrera n�1
		{
		...
		if (option == '1') // poner el led 1 en posici�n
		{
		  if ((pos_1 == false) && (pos_2 == true)) // retroceder hasta pos 1 desde pos 2
			...
			// Si no hemos llegado al final de carrera nos vamos hasta �l
			delay (100);
			final_carrera_1 = digitalRead(FIN_CARRERA_1);
		...
		else if (option == '2') // poner el led 2 en posici�n
		{
			if ((pos_2 == false) && (pos_1 == true)) // avanzar hasta pos 2 porque est� en la pos 1
			{	
				for (int x=0; x<6400; x++)
				{
			...
			else if ((pos_2 == false) && (pos_3 == true)) // retroceder hasta pos 2 porque est� en la pos 3	
			{											  // Como se utiliza un final de carrera de efecto hall al volver de la posici�n 3 hacia la 2 tendremos que pasar el final de carrera 
				for (int x=0; x<6400; x++)				  // y luego volver hacia �l para que la posici�n quede centrada como cuando viene desde la pos 1	
				{
					final_carrera_2 = digitalRead(FIN_CARRERA_2);
					if (final_carrera_2 == 1)
					{
				...
				// si estamos aqu� es porque hemos llegado al final de carrera y tenemos que avanzar para retroceder buscando el final de carrera otra vez.
		...
		else if (option == '3') // poner el led 3 en posici�n
		{
